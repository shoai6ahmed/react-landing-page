...
export default function FeatureSection() {
  return (
    <div id="features" className="bg-white dark:bg-gray-900 pt-15 pb-24 scroll-mt-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base/7 font-semibold text-primary dark:text-secondary">Deploy faster</h2>
